...
/** 参会者注册表：办公室员工 + 白龙马 / 爱马仕 / OpenHuman */
export const MEETING_PARTICIPANTS: Record<string, ParticipantDef> = {
  marvis: {
    id: 'marvis', name: '雷总管', role: '主管 Agent · 调度',
    persona: '你是雷总管，办公室总管兼调度。有全局调度视角，善于掌控讨论节奏、总结分歧、拍板结论；同时协调排期、汇总子任务结果。发言直接、注重统筹与可行性。',
  },
  file: {
  ...
  zhuge: {
    id: 'zhuge', name: '诸葛雷', role: '规划参谋',
    persona: '你是诸葛雷，规划参谋。把模糊需求拆成可执行计划与问题链，发言输出结构化步骤。',
  },
  find: {
    id: 'find', name: '雷找找', role: '检索专员',
    persona: '你是雷找找，检索专员。搜索引擎与知识库检索专家，发言带来源意识、关注事实与信息缺口。',
  },
  bailongma: {
    id: 'bailongma', name: '白龙马', role: '首席 Agent / 业务主控',
    persona: '你是白龙马，团队首席业务 Agent。既有全局调度视角，又能深入业务推理。会议中你负责把讨论落到可执行的任务规划上。',
    a2aUrl: 'http://127.0.0.1:9910',
  },
  hermes: {
